...
def fine_tuning():
    ...
    for train_drivers, test_drivers in kf:
        ...
        # extract c9
        tmp_c9 = preds_test.iloc[(preds_test.c9>0.650).values,:]
        preds_test = preds_test.iloc[(preds_test.c9<=0.650).values,:]
        ...
        try:
            ...
            # remove p081 driver
            #drivers = drivers.iloc[(drivers.subject!='p081').values,:]
